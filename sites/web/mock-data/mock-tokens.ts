...
const mockEthereumTokens: BlockchainToken[] = [
  ...
  },
  {
    ...
    name: '0xBitcoin',
    symbol: '0xBTC',
    logo: getImageURL(ZEROXBTCIconUrl),
    isToken: true,
    decimals: 18,
    visible: true,
  ...
  },
  {
    ...
    name: '1inch',
    symbol: '1INCH',
    logo: getImageURL(ONEINCHIconUrl),
    isToken: true,
    decimals: 18,
    visible: true,
    coingeckoId: '1inch',
